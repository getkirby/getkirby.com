...
<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/" xmlns:moz="http://www.mozilla.org/2006/browser/search/">
  ...
  <Image width="16" height="16" type="image/x-icon"><?= url('assets/images/favicon.ico') ?></Image>
  <Image width="64" height="64" type="image/png"><?= (new Kirby\Toolkit\File(kirby()->root('index') . 'assets/images//opensearch.png'))->base64() ?></Image>
