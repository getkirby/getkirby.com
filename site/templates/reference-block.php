...
```
  ...
  <p><a href="https://github.com/getkirby/kirby/blob/main/panel/src/components/Forms/Blocks/Types/<?= ucfirst($page->title()) ?>.vue">kirby/blob/main/panel/src/components/Forms/Blocks/Types/<?= ucfirst($page->title()) ?>.vue</a></p>
</div>
