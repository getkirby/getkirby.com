...
<p class="text-lg text-center mb-12">
	Kirby 6 is a <strong>free upgrade</strong> for everyone with a <a href="/buy" class="link">valid Kirby Basic or Enterprise license</a>.
</p>
<?php endsnippet() ?>

<?php snippet('templates/release-6/migration') ?>
