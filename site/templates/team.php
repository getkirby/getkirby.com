...
<article>
	...
	<div class="mb-24">
		<h2 class="h2 mb-6">About the company</h2>
		<div class="columns" style="--columns: 4; --gap: var(--spacing-2)">
			<section class="box p-6 prose">
				<h3>Est. 2012</h3>
				<p>Kirby started in <a href="/10" class="link">2012</a> as a side project by Bastian. Over the years, the team has grown from within our <a href="/meet" class="link">community</a>.</p>
	...
	<div class="mb-24">
		<h2 class="h2 mb-6">Our values</h2>
		<div class="columns" style="--columns: 4; --gap: var(--spacing-2)">
			<section class="box p-6 prose">
				<h3>Small & caring</h3>
	...
	<div class="mb-24">
		<h2 class="h2 mb-6">It’s not just us</h2>
		<div class="columns" style="--columns: 4; --gap: var(--spacing-2)">
			<section class="box p-6 prose">
				<h3>Partners</h3>
