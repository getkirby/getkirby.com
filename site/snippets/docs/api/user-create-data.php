...
| `name` | `string` | <code></code> | Optional display name, which will be used in the panel |
| `content` | `array` | <code></code> | Additional content fields. Must be defined as key/value object |
