<?php snippet('templates/features/section', [
  ...
  'text'  => 'Our new Fiber architecture splits the Panel in areas: site area, users area, settings area, etc. You can create your own areas and build entire applications on top of the Panel. <a href="/releases/3.6/features/fiber">Learn more &rsaquo;</a>',
