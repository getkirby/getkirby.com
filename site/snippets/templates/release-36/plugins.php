<?php snippet('templates/features/section', [
  ...
  'text'  => 'Our new Fiber architecture splits the Panel in areas. Site area, users area, settings area, etc. You can now create your own areas and build entire applications on top of the Panel.',
