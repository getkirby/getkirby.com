<?php snippet('templates/features/section', [
  ...
  'text'  => 'With increasingly better browser support for WebP and AVIF on the horizon, optimizing images becomes a lot easier. <br><br> The performance benefits are obvious. WebP can produce high quality images with roughly 50% smaller files compared to JPEG and AVIF can go even lower than that.<br><br>Our image processing engine now supports both formats and with the help of the picture element you can make even older browsers happy. <a href="/docs/guide/templates/resize-images-on-the-fly#image-formats">Learn more &rsaquo;</a></p>',
