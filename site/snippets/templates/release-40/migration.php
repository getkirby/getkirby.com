<section id="migration" class="mb-42">
	...
	<div class="release-text-box" style="background: var(--color-light)">
		<div class="columns" style="--columns: 2; --gap: var(--spacing-24)">
			<div class="prose">
				<p>Kirby 4 is a major release and requires some changes to existing sites. To ease the transition, we have compiled everything you need to know in a handy guide:</p>

				<p>
					<a href="<?= url('docs/guide/updates/update-to-v4') ?>">Migration guide →</a><br>
				</p>
			</div>
			...
			<div class="prose">
				<?= kirbytext(
					'<info>' .
								'If you are updating from Kirby 3.9 or older, please first perform each major update step by step. ' .
