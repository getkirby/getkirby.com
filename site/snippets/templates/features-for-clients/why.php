<?php snippet('templates/features/section', [
  'id' => 'reasons-for-kirby',
  'title' => 'It does not have to be a website',
  'intro' => 'Kirby as your single point of truth',
  'text' => 'A CMS is no longer all about building websites. Your content should be ready for any device, platform and audience. Let Kirby be the single point of truth in your organization. Combine it with various other systems. Gather data and simultaneously deliver it to the web, the mobile world, print and maybe even your fridge.',
