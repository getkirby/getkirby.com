...
>
	<header class="partner-listing-header">
		...
		<h4 class="field h3">
			<label>
				<span :style="labelStyle(personalInfo.businessName)">
	...
	<figure class="partner-listing-image">
		<?= icon('image') ?>
		<span
			v-if="personalInfo.tier === 'certified' && view === 'details'"
			v-cloak
		>
	...
	<aside class="partner-listing-footer">
		...
		<p class="field partner-listing-location">
			<label>
				<span :style="labelStyle(personalInfo.location)">
...
<p
	v-if="personalInfo.tier === 'regular' && view === 'details'"
	v-cloak
	class="image-info"
>
	We will ask you for an image once your application has been accepted.
